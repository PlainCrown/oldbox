...
const SHAPE_DROP_SOUND = preload("res://Assets/Sounds/shape_drop.wav")
const LINE_BREAK_SOUND = preload("res://Assets/Sounds/line_break.wav")
const GAME_OVER_SOUND = preload("res://Assets/Sounds/game_over.wav")
const SHAPES = [
