...
const PAUSE_IMG = preload("res://Assets/UI/pause.png")
const PAUSE_RED_IMG = preload("res://Assets/UI/pause_red.png")
const UNPAUSE_IMG = preload("res://Assets/UI/unpause.png")
const UNPAUSE_RED_IMG = preload("res://Assets/UI/unpause_red.png")
...
func _ready() -> void:
	...
	if Autoload.invisible_mode:
		game_type += 2
		invisible_mode.show()
	most_lines.text = "%04d" % Autoload.shapeplacer_highscore_dictionary[game_type]
...
# warning-ignore:integer_division
	...
	if score > Autoload.shapeplacer_highscore_dictionary[game_type]:
		Autoload.shapeplacer_highscore_dictionary[game_type] = score
